...
then
	mod_dir="/data1/fast_ucmain_test";
	./lcmd cu_3 "cd $mod_dir/proj; make clean; make"

	mod_dir="/data1/twse_spider_test/cu";
	./lcmd cu_3 "cd $mod_dir/proj; make clean; make"

	#make eu for test
	mod_dir="/data1/twse_spider_test/videoeu/src/VEDIOEU";
	./lcmd cu_3 "cd $mod_dir/project; make clean; make"
