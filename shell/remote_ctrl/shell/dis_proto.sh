...
then
	...
	echo 'please input target{all|online|link|test|extractor}'
	exit;
fi
...
then
	#fast ucmain
	proto_header_dir="/data1/fast_ucmain_test/modules/protodesc/";
	proto_data_dir="/data1/fast_ucmain_test/bin/";
	dst_host="cu_3";
	dis_fun;

	#cu & eu
	proto_header_dir="/data1/twse_spider_test/common/protocol/include/";
	proto_data_dir="/data1/twse_spider_test/data/";
	dst_host="cu_3";
	dis_fun;
